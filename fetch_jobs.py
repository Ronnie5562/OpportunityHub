import requests
# this file  fetches  job opportunity from the API's of job platforms and then sends it to users
...
#funtion to get information from user on which job opportunity they are looking for.
